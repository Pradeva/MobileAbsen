...
>>>>>>> b502ef3f06da8c783edcffff6f5808e70d3ebd88
...
export const fetchCuti = createAsyncThunk('user/fetchCuti', async({idUser}, thunkAPI) => {
    try {
        console.log(idUser)
        const response = await fetch(`http://192.168.43.22:8000/api/cuti?users_id=${idUser}`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                // "Authorization": "Bearer " + token,
...
export const fetchLembur = createAsyncThunk('user/fetchLembur', async({idUser}, thunkAPI) => {
    try {
        console.log(idUser)
        const response = await fetch(`http://192.168.43.22:8000/api/lembur?users_id=${idUser}`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                // "Authorization": "Bearer " + token,
